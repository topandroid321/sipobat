...
$table = '<table style="border:1px solid #000; padding:6px;">';
 $table .= '<tr style="background-color:rgb(130, 91, 209)">
              ...
              <th style="border:1px solid #000;">Tanggal Permintaan</th>
  ...
  foreach ($data->result() as $row) {
    $table .='<tr>
        ...
        <td style="border:1px solid #000;">'.$row->tgl_permintaan.'</td>
        <td style="border:1px solid #000;">'.$row->nama_obat.'</td>
        <td style="border:1px solid #000;">'.$row->jumlah.'</td>
        <td style="border:1px solid #000;">'.$row->satuan.'</td>
    </tr>';
  }
$table .= '</table>';
...
ob_clean();
$pdf->Output('Laporan Data Permintaan.pdf', 'I');
